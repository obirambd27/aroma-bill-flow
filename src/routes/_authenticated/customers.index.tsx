            ...
            <table className="w-full min-w-[860px]">
              <thead>
                <tr className="border-b border-border text-left text-xs font-medium uppercase tracking-wide text-muted-foreground">
                  ...
                  <SortHeader label="Name" column="name" sort={sort} dir={dir} onSort={onSort} />
                  ...
                  <SortHeader
                    ...
                    className="text-right"
                  />
                  <SortHeader label="Aging" column="aging" sort={sort} dir={dir} onSort={onSort} />
                  <SortHeader
                    label="Last purchase"
                    column="last"
                    sort={sort}
                  ...
                  >
                    ...
                    <td
                      className={`numeric px-4 py-3 text-right text-sm font-semibold ${
                        outstanding > 0 ? "text-warning-foreground" : "text-muted-foreground"
                      }`}
                    >
                    ...
                    <td className="px-4 py-3">
                      {aging ? (
                        <StatusBadge tone={agingTone(aging)}>{agingLabel[aging]}</StatusBadge>
                      ) : (
