CREATE OR REPLACE FUNCTION public.audit_stock_ledger(p_repair boolean DEFAULT false, p_skip_transfer_repair boolean DEFAULT false)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY INVOKER
...
BEGIN
  ...
  LOOP
    ...
    IF p_repair AND NOT p_skip_transfer_repair THEN
...
REVOKE EXECUTE ON FUNCTION public.audit_stock_ledger(boolean, boolean) FROM anon, public;
GRANT EXECUTE ON FUNCTION public.audit_stock_ledger(boolean, boolean) TO authenticated, service_role;